...
Ambient PM2.5 attributed deaths increased from 3.5 million in 1990 to 4.2 million in 2015, thus leading to become the fifth-ranking cause of global deaths [Cohen, A.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5439030/). In 2015 the Environmental Protection Agency (EPA) proposed the Clean Air Act section 111(d) to implement emission guidelines for power plants. Additionally, the collaborative alliance between states, tribes and the federal government was established to reduce air pollution for public safety and protecting the environment [(EPA)]( https://archive.epa.gov/epa/cleanpowerplan/fact-sheet-clean-power-plan-proposed-federal-plan.html#:~:text=On%20August%203%2C%202015%2C%20the,that%20began%20construction%20on%20or). In the evaluation of potential decrease in greenhouse gas emissions (GHG) in NYC, suggested policy measure tested may result in an annual reduction of 160-290 deaths attributed to PM2.5[(Johnson, S. 2020)](https://pubs.acs.org/doi/10.1021/acs.est.0c00694). In NYC specifically, PM2.5 concentration from 2015-2020 had a similar decline between January and May [Zangari,S.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7314691/#bb0010). Asthma incidence, hospital admissions, and emergency visits were evaluated in relation to PM2.5 levels. With a calculated 23% improvement in PM2.5 levels, illness and death were calculated to be avoided and have an economic benefit of \$31.8 billion and \$77 billion for the years 2021-2025 [(Perera, F. 2021)](https://www.sciencedirect.com/science/article/pii/S0013935120314523?via%3Dihub). Interactive effects of PM2.5 and O3 on daily mortality showed a synergistic effect in total, cardiovascular, and respiratory mortality. In relation to respiratory mortality, PM2.5 had a higher impact on cases in higher altitudes with higher O3 exposure [(Liu, C.)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10548261/). Since O3 has low water-solubility, inhaling ozone may influence lung health. In European cities, increased concentrations of daily O3  during warm periods was observed to cause an increase in daily number of respiratory deaths by 1.13% [(Manisalidis, I.)]( https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7044178/). Furthermore, long term effects of NO2 can cause chronic lung disease due to its ability to penetrate deep into the lungs and can have effects on the cellular level [(Manisalidis, I.)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7044178/).
...
## DF for time series by neighboorhood (maps measurement sites to neighborhoods)
...
Time series plots were created for daily air concentrations. After restricting our analysis to roughly 2020 to 2022, we generate visualizations of the distributions of certain pollutants of interest. Trend and seasonal patterns of Carbon Monoxide (CO), Ozone (O3), and Nitrogen Dioxide (N02) showed oscillations throughout the year. Specifically, O3 showed the a greater difference and reached high levels during the summer month a opposed to NO2 which peaked in the winter. PM2.5 showed a steady concentration trend and did not display seasonal patterns. 
...
#### Histogram of illness
The distribution of disease counts and ER visits/admissions was graphed. A right skewedness was seen in all histograms. 
```{r, warning = FALSE}
...
#### Boxplot Disease Counts
Boxplots of each disease or admission visits were plotted by borough. Each disease or admission visit had similar distributions, however, Brooklyn and Bronx showed higher ED visits.  
