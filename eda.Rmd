...
add_yearly_boxplots(df_histo_pm2.5, all_years, "PM2.5")
add_yearly_boxplots(df_histo_NO2, all_years, "NO2")
add_yearly_boxplots(df_histo_ozone, all_years, "O3")
...
combined_boxplot_fig = combined_boxplot_fig |>
  layout(title = "Comparison of Pollutant Concentrations (Boxplots)",
         updatemenus = list(list(type = "dropdown", buttons = buttons)))
